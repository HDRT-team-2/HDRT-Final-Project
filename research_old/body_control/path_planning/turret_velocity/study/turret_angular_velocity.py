...
# 데이터 불러오기
df = pd.read_excel("research/body_control/path_planning/turret_velocity/data/turret_angular_velocity.xlsx")
...
plt.tight_layout()
plt.savefig('source/research/body_control/path_planning/turret_velocity/consequence.png')
plt.show()

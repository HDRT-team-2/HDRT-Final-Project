...
obstacle_pos = {"x": 0.0, "y": 0.0, "z": 0.0}
# --------------------------------------------------------------------
...
def send_vdrs(request_data=None):
    ...
    request_data = {
        ...
        "obstacle_pos": obstacle_pos # 임시 장애물 위치 데이터
    }
            ...
            if global_replan_required == True: # 경로 재계산이 필요하면서
                if new_fire_point is None: # 목표 지점이 설정되지 않은 경우
                    ...
                    request_data_tpp = {
                        ...
                        "enemies": enemy_list.get_all_enemies()  # 적대 객체(적군) 정보
                    }
...
def update_obstacle():
    ...
    for idx, obstacle in enumerate(obstacles):
        try:
            ...
            obstacle_pos = {"x": pos_x, "y": pos_y, "z": pos_z}

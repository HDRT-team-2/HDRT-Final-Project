...
# 데이터 읽기
stop_method = 'stop'
excel_path = f'source/research/body_control/path_planning/stop_velocity/input_data/stop_velocity_{stop_method}.xlsx'
...
plt.legend()
plt.tight_layout()
plt.savefig(f'source/research/body_control/path_planning/stop_velocity/output_data/stop_{stop_method}.png')
plt.show()

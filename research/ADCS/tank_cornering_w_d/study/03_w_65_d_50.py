...
EXCEL_PATH = "source/research/body_control/path_planning/tank_cornering_w_d/input_data/w_65_d_50.xlsx"
...
plt.tight_layout()
plt.savefig('source/research/body_control/path_planning/tank_cornering_w_d/output_data/w_65_d_50.png')
plt.show()
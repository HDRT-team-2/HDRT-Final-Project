...
for ax, method in zip(axes, methods):
    excel_path = f'source/research/body_control/path_planning/stop_velocity/input_data/stop_velocity_{method}.xlsx'
    df = pd.read_excel(excel_path)
    process_and_plot(df, method, ax, min_running_time=17.0)

plt.tight_layout()
plt.savefig('source/research/body_control/path_planning/stop_velocity/output_data/stop_all_methods.png')
plt.show()
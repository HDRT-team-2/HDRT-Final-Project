...
# 데이터 불러오기
df = pd.read_excel(f"source/research/body_control/path_planning/tank_turn_d/input_data/tank_d_turn_{v}.xlsx")
...
plt.tight_layout()
plt.savefig(f'source/research/body_control/path_planning/tank_turn_d/output_data/tank_d_turn_{v}.png')
plt.show()

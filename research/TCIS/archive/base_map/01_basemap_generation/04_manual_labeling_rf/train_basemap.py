...
class BaseMapSegmenter:
    def __init__(self):
        ...
        # 라벨 정보
        self.labels = {
            0: {"name": "배경", "color": (230, 230, 230)},
            1: {"name": "물", "color": (105, 195, 255)},
            2: {"name": "돌", "color": (150, 150, 150)},
            3: {"name": "건물", "color": (154, 157, 173)},
            4: {"name": "길", "color": (253, 255, 135)},
            5: {"name": "나무", "color": (141, 201, 141)},
        }
    ...
    def train(self):
        ...
        model_path = model_dir / "basemap_model.pkl"
    ...
    def predict(self, image_path, model_path="models/basemap_model.pkl"):
        """이미지 예측"""
        # 모델 로드
        if Path(model_path).exists():
            self.model = joblib.load(model_path)
        else:
            print("오류: 모델 파일이 없습니다. 먼저 학습하세요.")
            return None

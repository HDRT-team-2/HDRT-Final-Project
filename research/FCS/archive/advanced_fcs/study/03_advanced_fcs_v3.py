...
def fcs_function(request_data):
    global rf_command, rf_weight, fire_command, fire_target, new_fire_point
    ...
    turret_min_angle = corrected_body_y - 3
    turret_max_angle = corrected_body_y + 6  # 최대 10도까지만 허용
